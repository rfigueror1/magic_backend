...
class TemperaturesHandler:
    ...
    def largest_fluctuation_station(self, ranges=None):
        """
            ...
            O: tuple
        """
        # sort by station depending if ranges of dates given
        if ranges:
        ...
        temp_total_fluct = 0
        fluct_station = None
        # obtain iteratively total fluctuation by station, update max value
    ...
    def largest_fluctuation_station_by_dates(self, range_dates):
        ...
        # get largest fluctuation for range between dates
